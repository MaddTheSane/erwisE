...
#define PUBLIC	extern		/* Accessible outside this module     */
...
extern        void    msg_init(int height);
extern        void    msg_printf(int y, const char *fmt, ...);
extern        void    msg_exit(int wait_for_key);
